                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">Frenchiese Register</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="{{ route('index') }}">Home</a></li>
                                <li class="ec-breadcrumb-item active">Frenchiese Register</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="ec-register-wrapper col-md-7">
                    <div class="ec-register-container">
                        <div class="ec-register-form">
                            <form id="valid_form" action="{{route('customer.frenchiese_register')}}" method="post">
                                @csrf
                                ...
                                <span class="ec-register-wrap ec-register-half">
                                    ...
                                    <input type="text" id="pasword" class="form-control" name="password" placeholder="" required />
                                ...
                                <span class="ec-register-wrap ec-register-half">
                                    ...
                                    <input type="text" id="confirm_password" class="form-control" name="confirm_password" placeholder="" required />
