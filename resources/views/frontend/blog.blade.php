                            ...
                            <div class="row">
                                    ...
                                    <div class="ec-blog-inner">
                                        <div class="ec-blog-image">
                                            <a href="{{route('blog_details')}}">
                                                <img class="blog-image" src="{{asset('public/frontend/assets/images/blog-image/1.jpg')}}"
                                                    alt="Blog" />
                                            </a>
                                        </div>
                                        <div class="ec-blog-content">
                                            <h5 class="ec-blog-title"><a
                                                    href="{{route('blog_details')}}">The best fashion influencers.</a></h5>

                                            <div class="ec-blog-date">By <span>Mr Admin</span> / Sep 10, 2022-2023</div>
                                ...
                                <div class="col-md-6 col-sm-12 mb-6 ec-blog-block">
                                    <div class="ec-blog-inner">
                                        ...
                                        <div class="ec-blog-content">
                                            <h5 class="ec-blog-title"><a
                                                    href="{{route('blog_details')}}">Vogue Shopping Weekend 2022.</a></h5>

                                            <div class="ec-blog-date">By <span>Mr Admin</span> / February 10, 2022-2023</div>
                                            <div class="ec-blog-desc">Lorem Ipsum is simply dummy text of the printing
                                                and typesetting industry. Lorem Ipsum has been the industry's standard
                                                dummy text ever since the 1500s,</div>
                                ...
                                <div class="col-md-6 col-sm-12 mb-6 ec-blog-block">
                                    <div class="ec-blog-inner">
                                        ...
                                        <div class="ec-blog-content">
                                            <h5 class="ec-blog-title"><a
                                                    href="{{route('blog_details')}}">Winter 2022 Trending Fashion Market</a></h5>
                                ...
                                <div class="col-md-6 col-sm-12 mb-6 ec-blog-block">
                                    <div class="ec-blog-inner">
                                        ...
                                        <div class="ec-blog-content">
                                            <h5 class="ec-blog-title"><a
                                                    href="{{route('blog_details')}}">Fashion Market Reveals Her Jacket.</a></h5>
                                ...
                                <div class="col-md-6 col-sm-12 mb-6 ec-blog-block">
                                    <div class="ec-blog-inner">
                                        ...
                                        <div class="ec-blog-content">
                                            <h5 class="ec-blog-title"><a
                                                    href="{{route('blog_details')}}">Summer Trending Fashion Market.</a></h5>
                        ...
                        <div class="ec-sidebar-block ec-sidebar-recent-blog">
                            ...
                            <div class="ec-sb-block-content">
                                <div class="ec-sidebar-block-item">
                                    ...
                                    <div class="ec-blog-date">February 10, 2022-2023</div>
                                </div>
                                <div class="ec-sidebar-block-item">
                                    <h5 class="ec-blog-title"><a href="{{route('blog_details')}}">Vogue Shopping Weekend.</a></h5>
                                    <div class="ec-blog-date">March 14, 2022-2023</div>
                                </div>
                                <div class="ec-sidebar-block-item">
                                    <h5 class="ec-blog-title"><a href="{{route('blog_details')}}">Fashion Market Reveals Her Jacket.</a></h5>
                                    <div class="ec-blog-date">June 09, 2022-2023</div>
                                </div>
                                <div class="ec-sidebar-block-item">
                                    <h5 class="ec-blog-title"><a href="{{route('blog_details')}}">Summer Trending Fashion Market.</a></h5>
                                    <div class="ec-blog-date">July 17, 2022-2023</div>
                                </div>
                                <div class="ec-sidebar-block-item">
                                    <h5 class="ec-blog-title"><a href="{{route('blog_details')}}">Winter 2022 Trending Fashion Market.</a></h5>
                                    <div class="ec-blog-date">August 02, 2022-2023</div>
                                </div>
                            </div>
                        </div>
                        <!-- Sidebar Recent Blog Block -->
