                ...
                <div class="row m-1">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit Sales Member</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card card-outline card-info">
                            <div class="card-body p-0">
                                <div class="modal-body">
                                    ...
                                    <form action="{{route('admin.sales.team.update',$user->id)}}" method="POST" id="form" class="form-example">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="first_name" class="form-control" value="{{$user->userDetail->first_name}}" placeholder="First Name..." required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="middle_name">Middle Name</label>
                                                    <input type="text" name="middle_name" class="form-control" value="{{$user->userDetail->middle_name}}" placeholder="Middle Name...">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="last_name">Last Name</label>
                                                    <input type="text" name="last_name" class="form-control" value="{{$user->userDetail->last_name}}" placeholder="Last Name..." required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="dob">DOB</label>
                                                    <input type="date" name="dob" class="form-control" max="{{Carbon\Carbon::now()->subYears(12)->format('Y-m-d')}}" value="{{$user->userDetail->dob}}" placeholder="DOB...">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="phone">Phone</label>
                                                    <input type="number" name="phone" class="form-control" value="{{$user->phone}}" placeholder="Phone..." required>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="adhar_number" class="form-control" value="{{$user->userDetail->adhar_number}}" placeholder="Adhar Number...">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                                        ...
                                                        <input type="hidden" name="adhar_front_image" class="selected-files" value="{{$user->userDetail->adhar_front_image}}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                                        ...
                                                        <input type="hidden" name="adhar_back_image" class="selected-files" value="{{$user->userDetail->adhar_back_image}}">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text bg-soft-secondary font-weight-medium">Browse</div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pan_number" class="form-control" value="{{$user->userDetail->pan_number}}" placeholder="Pan Number...">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                                        ...
                                                        <input type="hidden" name="pan_image" class="selected-files" value="{{$user->userDetail->pan_image}}">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text bg-soft-secondary font-weight-medium">Browse</div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                                        ...
                                                        <input type="hidden" name="profile_image" class="selected-files" value="{{$user->userDetail->profile_image}}">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text bg-soft-secondary font-weight-medium">Browse</div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="marital_status" class="form-control">
                                                        ...
                                                        <option value="single" @if($user->userDetail->marital_status == 'single') selected @endif>Single</option>
                                                        <option value="married" @if($user->userDetail->marital_status == 'married') selected @endif>Married</option>
                                                        <option value="widow_widower" @if($user->userDetail->marital_status == 'widow_widower') selected @endif>Widow / Widower</option>
                                                        <option value="divorced" @if($user->userDetail->marital_status == 'divorced') selected @endif>Divorced</option>
                                                        <option value="separated" @if($user->userDetail->marital_status == 'separated') selected @endif>Separated</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" class="form-control" placeholder="Address...">{{$user->userDetail->address}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tbody id="table_body">
                                                        ...
                                                        @foreach ($user->qualification as $qualification)
                                                            <tr class="tr_class">
                                                                <input type="hidden" name="qualification_ids[]" value="{{$qualification->id}}">
                                                                <td>
                                                                    <input type="text" name="qualification[]" class="form-control" value="{{$qualification->qualification}}" placeholder="Qualification..." required>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="university[]" class="form-control" value="{{$qualification->university}}" placeholder="University..." required>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="institute_name[]" class="form-control" value="{{$qualification->institute_name}}" placeholder="Institute Name..." required>
                                                                </td>
                                                                <td>
                                                                    <input type="number" name="year_of_passing[]" min="{{Carbon\Carbon::now()->subYear(100)->format("Y")}}" max="{{Carbon\Carbon::now()->format("Y")}}" step="1" value="{{$qualification->year_of_passing}}" class="form-control" placeholder="Year Of Passing..." required>
                                                                </td>
                                                                <td>
                                                                    <input type="number" step="0.01" name="percentage[]" class="form-control" value="{{$qualification->percentage}}" placeholder="Percentage..." required>
                                                                </td>
                                                                <td>
                                                                    <input type="number" name="marks_memo[]" class="form-control" value="{{$qualification->marks_memo}}" placeholder="Marks Memo..." required>
                                                                </td>
                                                                <td>
