<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-image: linear-gradient(to right,#664b29,#ab8234)!important;">
    <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link btn btn-success float-right" href="{{route('products.create')}}">Add Product <i class="fas fa-plus"></i></a>
        </li>
    </ul>
