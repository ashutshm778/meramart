                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                                            ...
                                                            <input type="hidden" name="icon" id="icon" class="selected-files" value="">
                                                ...
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="start_date" id="start_date" min="{{date('Y-m-d')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        <label for="end_date">End Date</label>
                                                        <input type="date" name="end_date" id="end_date" min="{{date('Y-m-d')}}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
...
<script>
    ...
    function save_offer_product()
    {
        if(validate_form())
        {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('admin.save.offers.products')}}",
                data:{
                    values:values,
                    ids:ids,
