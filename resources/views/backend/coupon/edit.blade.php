                                            ...
                                            <div class="row">
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="type" class="form-control select2" id="type" onchange="get_product()">
                                                            ...
                                                            <option value="total_order_amount" @if($coupon->type == 'total_order_amount') selected @endif>Total Order Amount</option>
                                                            <option value="product_base" @if($coupon->type == 'product_base') selected @endif>Product Base</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="code" id="code" value="{{$coupon->code}}" class="form-control" placeholder="Enter Code...">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                                            ...
                                                            <input type="hidden" name="image" class="selected-files" value="{{$coupon->image}}">
                                                ...
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control summernote" name="description">{!!$coupon->description!!}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        <label for="minimum_order_value">Minimum Order Value</label>
                                                        <input type="number" step="0.01" min="0.00" name="minimum_order_value" id="minimum_order_value" value="{{$coupon->minimum_order_value}}" class="form-control" placeholder="Enter Minimum Order Value...">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        <label for="maximum_discount_amount">Maximum Discount Amount</label>
                                                        <input type="number" step="0.01" min="0.00" name="maximum_discount_amount" id="maximum_discount_amount" value="{{$coupon->maximum_discount_amount}}" class="form-control" placeholder="Enter Maximum Discount Amount...">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        <label for="discount">Discount</label>
                                                        <input type="number" step="0.01" min="0.00" name="discount" id="discount" class="form-control" value="{{$coupon->discount}}" placeholder="Enter Discount...">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="1" name="number_of_usages" id="number_of_usages" value="{{$coupon->number_of_usages}}" class="form-control" placeholder="Enter Number Of Usages...">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="date_range" value="{{date('m/d/Y',$coupon->start_date)}} - {{date('m/d/Y',$coupon->end_date)}}" class="form-control float-right" id="reservation" placeholder="Select Date Range...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 form_div @if($coupon->type != 'product_base') d-none @endif" id="add_more_product_div" style="margin-top:30px">
                                                    <div class="form-group">
...
<script>
    ...
    @foreach (explode(',',$coupon->product_ids) as $product_id)
        setLoc('{{$product_id}}')
    @endforeach
    function setLoc(id){
        ...
        if (cart == null || present_or_not == null || present_or_not == -1)
        {
            ...
            pcart.push(product);
            localStorage.setItem('product', JSON.stringify(pcart));
            get_product_table()
        }
    }
