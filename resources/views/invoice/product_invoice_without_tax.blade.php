                        ...
                        <div class="page">
                            ...
                            <div id="company-details">
                                <div id="company-details-meta">
                                    <div id="company-logo-container">
                                        <img id="company-logo" src="{{asset('public/'.api_asset(websiteSettingValue('logo')))}}" />
                                    </div>
                                    <div id="company-details-content">
                                        ...
                                        <div id="company-contact-details">
                                            <div id="company-mobile-number-content">
                                                <span>Mobile:</span>&nbsp;
                                                <span id="company-mobile-number">{{websiteSettingValue('phone')}}</span>
                                            </div>
                                ...
                                <div id="invoice-details-meta">
                                    <div id="invoice-main-details">
                                        ...
                                        <div id="invoice-date-container">
                                            ...
                                            <div id="invoice-date">{{$order->created_at->format('d-M-Y h:i A')}}</div>
                                        </div>
                            ...
                            <table id="items-table">
                                ...
                                <tbody id="items-table-content">
                                    ...
                                    <tr>
                                        <td class="items-table-info item-serial-number" style="">{{$key+1}}</td>
                                        <td class="items-table-info item-name-desc" style="">
                                            <div class="item-name">{{$order_detail->product->name}}</div>
                                        </td>
                                        <td class="items-table-info item-quantity items-qty-column" style="">{{$order_detail->quantity}} PCS
                                        </td>
                                        @php $total_quantity=$total_quantity+$order_detail->quantity; @endphp
                                        <td class="items-table-info item-mrp items-mrp-column" style=" nowrap">{{$order_detail->mrp_price}}</td>
                                        <td class="items-table-info item-rate items-rate-column" style="">{{$order_detail->price}}
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="items-table-total-qty" class="bold items-table-total items-qty-column"
                                            style="background-color: #F1E7CF;">{{$total_quantity}}</td>
                                        ...
                                        <td id="items-table-total-discount"
                                            ...
                                            style="background-color: #F1E7CF;">₹ {{$total_product_discount}}</td>
                                        <td id="items-table-total-amount" class="bold items-table-total nowrap"
                                            style="background-color: #F1E7CF;">₹ {{$total_product_price}}</td>
                                    </tr>
