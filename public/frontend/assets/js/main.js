...
function ecCheckCookie() {
    ...
    ecCheckCookie(), $(".clear-cach").on("click", function(a) {
        ...
        var c, d = b * window.innerHeight / 100,
        ...
        return c = document.querySelectorAll("[data-animation]:not([data-animated])"), window.addEventListener("load", a, !1), window.addEventListener("scroll", () => i(c), {
            passive: !0
    ...
    $(".cart-qty-plus-minus").append('<div class="ec_cart_qtybtn"><div class="inc ec_qtybtn">+</div><div class="dec ec_qtybtn">-</div></div>'), $(".cart-qty-plus-minus .ec_cart_qtybtn .ec_qtybtn").on("click", function() {
        ...
        $("button.add-to-cart").click(function() {}), $(".ec-btn-group.wishlist").click(function() {
        ...
        return a.preventDefault(), $(this).hasClass("in-out") ? ($(".bg-switcher").stop().animate({
            right: "0px"
        }, 100), $(".color-option-box").not("in-out") && ($(".skin-switcher").stop().animate({
            right: "-163px"
        }, 100), $(".color-option-box").addClass("in-out")), $(".layout-option-box").not("in-out") && ($(".layout-switcher").stop().animate({
            right: "-163px"
        }, 100), $(".layout-option-box").addClass("in-out"))) : $(".bg-switcher").stop().animate({
            right: "-163px"
        }, 100), $(this).toggleClass("in-out"), !1
        ...
        return a.preventDefault(), $(this).hasClass("in-out") ? ($(".lang-switcher").stop().animate({
            right: "0px"
        }, 100), $(".color-option-box").not("in-out") && ($(".skin-switcher").stop().animate({
            right: "-163px"
        }, 100), $(".color-option-box").addClass("in-out")), $(".layout-option-box").not("in-out") && ($(".layout-switcher").stop().animate({
            right: "-163px"
        }, 100), $(".layout-option-box").addClass("in-out"))) : $(".lang-switcher").stop().animate({
            right: "-163px"
        }, 100), $(this).toggleClass("in-out"), !1
    }), $(".ec-tools-sidebar-toggle").on("click", function(a) {
        return a.preventDefault(), $(this).hasClass("in-out") ? ($(".ec-tools-sidebar").stop().animate({
            right: "0px"
        }, 100), $(".ec-tools-sidebar-overlay").fadeIn(), $(".ec-tools-sidebar-toggle").not("in-out") && ($(".ec-tools-sidebar").stop().animate({
            right: "-200px"
        }, 100), $(".ec-tools-sidebar-toggle").addClass("in-out")), $(".ec-tools-sidebar-toggle").not("in-out") && ($(".ec-tools-sidebar").stop().animate({
            right: "0"
        }, 100), $(".ec-tools-sidebar-toggle").addClass("in-out"), $(".ec-tools-sidebar-overlay").fadeIn())) : ($(".ec-tools-sidebar").stop().animate({
            right: "-200px"
        }, 100), $(".ec-tools-sidebar-overlay").fadeOut()), $(this).toggleClass("in-out"), !1
    }), $(".ec-tools-sidebar-overlay").on("click", function(a) {
        $(".ec-tools-sidebar-toggle").addClass("in-out"), $(".ec-tools-sidebar").stop().animate({
            right: "-200px"
        }, 100), $(".ec-tools-sidebar-overlay").fadeOut()
