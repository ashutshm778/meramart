...
(function ($) {
    ...
    $(window).on('load resize', function () {
        setTimeout(function () {
            $('.ec-slider .slick-prev').prepend('<div class="prev-slick-arrow arrow-icon"><span>&#60;</span></div>');
            $('.ec-slider .slick-next').append('<div class="next-slick-arrow arrow-icon"><span>&#62;</span></div>');
            get_prev_slick_img();
            get_next_slick_img();
        }, 100);
    });
    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            $('#ec-testimonial-slider .slick-prev').prepend('<div class="prev-slick-arrow arrow-icon"><span>&#60;</span></div>');
            $('#ec-testimonial-slider .slick-next').append('<div class="next-slick-arrow arrow-icon"><span>&#62;</span></div>');
            get_prev_slick_img();
            get_next_slick_img();
        }, 500);
