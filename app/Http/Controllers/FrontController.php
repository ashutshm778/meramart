    ...
    private function buildTree($referralCode = null)
    {
        ...
        if (!$children->count()) {
            return [
                ...
                'f' =>'<div class=mytooltip><img src='.($node->verify_status == 1 ? (asset('public/public/frontend/user_profile/'.$node->photo)?: asset('/public/green.png')) : (asset('public/public/frontend/user_profile/'.$node->photo)?: asset('/public/red.png'))).' style=height:50px;width:50px;><a
